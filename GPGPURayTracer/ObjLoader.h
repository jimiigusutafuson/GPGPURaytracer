...
private: //functions
	...
	void readMaterial( vector<Material> *materials, vector<string> *texturePaths, vector<string> *normalPaths);
	void readMtlFile( string filename, vector<Material> *materials, vector<string> *texturePaths, vector<string> *normalPaths);
