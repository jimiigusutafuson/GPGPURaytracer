...
cbuffer cbCamera	: register(b0)		//48 bytes
{
...
cbuffer cbVertexInfo	: register(b1)	//16 bytes
{
	int noVertices;
	int noTriangles;
...
cbuffer cbSettings : register(b2)		//32  bytes
{
...
cbuffer cbLights : register(b3)			//416 bytes
{
